...
- **⚡ High Performance**: Fine-grained updates mean only the parts of your app that _need_ to update will update.
...
Ready to start? Head over to the [Getting Started](quickstart.md) guide!
